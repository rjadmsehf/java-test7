...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기
            ...
            서로 같은 값을 가지고 있자만, 두 배열은 서로 다른 배열이기에
        ...
        /* 필기 .
            ...
            그 외 3가지 방법은 복사하는 배열의 길이를 마음대로 조절할 수있다는 특징을 가진다.
         */
        int[] originArr = new int[] {1,2,3,4,5};

        print(originArr);

        /* 목차 1. for 문을 이용한 동일한 인덱스 값 복사*/
    ...
    public static void  print(int[] iarr) {
        ...
        System.out.println("iarr 의 hashDode : " + iarr.hashCode());
